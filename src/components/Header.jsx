...
const Header = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-gray-100/70 dark:border-white/10 bg-white/85 dark:bg-gray-900/85 backdrop-blur-2xl shadow-sm transition-colors duration-300">
